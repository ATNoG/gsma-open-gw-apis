    ...
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        if (direction && oldPages.length) {
          ...
          do {
            const param = currentPage === 0 ? (_a6 = oldPageParams[0]) != null ? _a6 : options.initialPageParam : getNextPageParam(options, result);
          ...
          queryFn: async ({ queryKey: [method2, path2, init2], pageParam = 0, signal }) => {
            ...
            const mergedInit = {
              ...
              params: {
                ...
                query: {
                  ...(_a5 = init2 == null ? void 0 : init2.params) == null ? void 0 : _a5.query,
