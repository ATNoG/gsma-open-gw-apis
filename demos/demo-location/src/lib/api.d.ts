...
export interface paths {
    ...
    "/quality-on-demand/v1/sessions": {
        ...
        put?: never;
        /** Create Session */
        post: operations["create_session_quality_on_demand_v1_sessions_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/quality-on-demand/v1/sessions/{sessionId}": {
        ...
        /** Get Qod Information By Id */
        get: operations["get_qod_information_by_id_quality_on_demand_v1_sessions__sessionId__get"];
        put?: never;
        post?: never;
        /** Delete Qod */
        delete: operations["delete_qod_quality_on_demand_v1_sessions__sessionId__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/quality-on-demand/v1/sessions/{sessionId}/extend": {
        ...
        post: operations["extend_session_duration_quality_on_demand_v1_sessions__sessionId__extend_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/quality-on-demand/v1/retrieve-sessions": {
        ...
        get?: never;
        put?: never;
        /** Get Qod Information By Device */
        post: operations["get_qod_information_by_device_quality_on_demand_v1_retrieve_sessions_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/device-roaming-status/v1/retrieve": {
        ...
        post: operations["retrieve_roaming_status_device_roaming_status_v1_retrieve_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CreateSession: {
            ...
            applicationServer: components["schemas"]["ApplicationServer"];
            ...
            devicePorts?: components["schemas"]["PortsSpec"] | null;
            /** @description A list of single ports or port ranges on the application server */
            applicationServerPorts?: components["schemas"]["PortsSpec"] | null;
            /**
             * Qosprofile
        ...
        ProvisioningInfo: {
            ...
            statusInfo?: components["schemas"]["app__schemas__qodProvisioning__StatusInfo"] | null;
        };
        /** QosProfile */
        QosProfile: {
            /**
        ...
        SessionInfo: {
             ...
             */
            expiresAt?: string | null;
            qosStatus: components["schemas"]["Status"];
            statusInfo?: components["schemas"]["app__schemas__quality_on_demand__StatusInfo"] | null;
        };
        /** SinkCredential */
        SinkCredential: {
         ...
         * @enum {string}
         */
        app__schemas__qodProvisioning__StatusInfo: "NETWORK_TERMINATED" | "DELETE_REQUESTED";
        /** Device */
         ...
         * @enum {string}
         */
        app__schemas__quality_on_demand__StatusInfo: "DURATION_EXPIRED" | "NETWORK_TERMINATED" | "DELETE_REQUESTED";
        /**
         * SubscriptionEventType
         * @enum {string}
         */
...
export interface operations {
    ...
    create_session_quality_on_demand_v1_sessions_post: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
    ...
    get_qod_information_by_id_quality_on_demand_v1_sessions__sessionId__get: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
    ...
    delete_qod_quality_on_demand_v1_sessions__sessionId__delete: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
    ...
    extend_session_duration_quality_on_demand_v1_sessions__sessionId__extend_post: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ExtendSessionDuration"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_qod_information_by_device_quality_on_demand_v1_retrieve_sessions_post: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RetrieveSessionsInput"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    retrieve_roaming_status_device_roaming_status_v1_retrieve_post: {
        parameters: {
            query?: never;
            header?: {
                /** @description Correlation id for the different services */
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RoamingStatusRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RoamingStatusResponse"];
                };
            };
            /** @description Problem with the client request */
            400: {
