...
This API consists of two main steps, sending a One Time Password via SMS and
verifying whether the result was correct or not, therefore we have two
endpoints, one for each action.

When calling the Send OTP endpoint a couple of things happen. First an
...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=15cm]{figs/OTP_sequence_diagram.png}
	}
	\caption{OTP SMS Sequence Diagram}
\end{figure}
